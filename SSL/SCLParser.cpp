...
void SCLParser::setTraceFile(FILE *f){
    tracefp = f;
}
...
void SCLParser::setOutputFile(FILE *f){
    outfp = f;
}
...
void SCLParser::Error(ErrorCode errCode)
{
    const char *msg;
...
void SCLParser::EmitOutputToken(OutputToken	tokenToEmit)
{
...
void SCLParser::SslChoice(int choiceTag)
{
